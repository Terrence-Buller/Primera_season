...
### for each year run loop trough different clubs ###
for year in years:
    for number in site_numbers:

        ### adjust the year to the right url ###
        chosenyear = year
        ...
        ### naming for the year in the database ###
        till_year = int(chosenyear)+1
        year_names_list = f"{chosenyear}/{till_year}"

        ### printing the link case of errors ###
        try:
        ...
        ### Making sure the team played primera division not segunda division ###
        ...
        ### condition if the amount of managers is different ###
        ...
        for table_element in amount_manager:
            ...
            ### loop through all numbers and give them a unique identifier ###
            for idx, element in enumerate(elements_number):
                element_dict[element] = idx

            number_elements = []

            ### Loop through the elements and take both identefier and integer ###
            ...
            ### Sorting the list by unique identifiers, so that the order remains ###
            ...
            ### Not all teams have called up, this takes care of both cases ###
            ...
            ### Splitting lineup and subsitute ###
